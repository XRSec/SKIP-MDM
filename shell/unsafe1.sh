...
declare -a dict
dict[1]="Disk Not Found (Use『Disk Utility』And Mount Macintosh HD)."
dict[2]="找不到磁盘 (请用『磁盘工具』挂载 Macintosh HD)."
dict[3]="Choose Ur SysDisk (Macintosh HD): "
...
dict[13]="Can't Open Hosts File"
dict[14]="无法打开 Hosts 文件"
dict[15]="MDM/DEP Blocked!"
dict[16]="屏蔽 MDM/DEP 完成!"
dict[17]="Exit Terminal > Open DiskUtil > Expand Disks > Find ${OSPATH}-Data > Mount > Exit DiskUtil > Back 2 Terminal & Rerun."
dict[18]="退出终端 > 打开磁盘工具 > 展开磁盘 > 找到 ${OSPATH}-Data > 装载 > 退出磁盘工具 > 回到终端重跑."
dict[19]="Cleaning MDM/DEP..."
dict[20]="正在清理 MDM/DEP..."
dict[21]="MDM/DEP Cleaned!"
dict[22]="清理 MDM/DEP 完成!"
dict[23]="Rebooting Mac..."
dict[24]="正在重启 Mac..."
dict[25]="Temp User, Plz Delete."
dict[26]="临时用户 请删除"
